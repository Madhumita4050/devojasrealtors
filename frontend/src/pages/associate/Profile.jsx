...
const Profile = () => {
  ...
  const handleProfileUpdate = async (e) => {
    e.preventDefault();
    try {
      await api.put('/associate/profile', profileForm);
  ...
  const handlePasswordChange = async (e) => {
    e.preventDefault();
    try {
      await api.put('/associate/change-password', passwordForm);
  ...
  const handleKycSubmit = async (e) => {
    e.preventDefault();
    try {
      await api.post('/associate/kyc', { document_url: kycUrl });
    ...
    <div className="space-y-6 max-w-2xl">
      ...
      <div className="card">
        ...
        <form onSubmit={handleProfileUpdate} className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-gray-700 mb-1 block">Referral Code</label>
            <input value={user?.referral_code || ''} disabled className="input-field bg-gray-50 text-gray-400" />
          </div>
